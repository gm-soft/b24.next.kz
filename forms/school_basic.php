...
case "initiated":
    ...
    <div class="container">
        ...
        <form id="form" class="form-horizontal" method="post" action="school_basic.php">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        <input type="number" step="1" min="0" class="form-control" id="pupil_count" name="pupil_count" required placeholder="Введите количество деетй (учеников)">
                    ...
                    "<div class=\"form-group\">"+
                        ...
                        "<div class=\"col-sm-9\">" +
                            "<input type=\"number\" step=\"1\" min=\"0\" class=\"form-control\" id=\"foodpack_price\" name=\"foodpack_price\" " +
                                "required placeholder=\"Введите стоимость фуд-пакета\" >" +
                        "</div>"+
                    "</div>";
            } else {
                html =
